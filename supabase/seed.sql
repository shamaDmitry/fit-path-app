-- Step 3: Seed Data (Corrected with instance_id)
...
(
  ...
  '{"provider": "email", "providers": ["email"]}',
  '{"full_name": "Marcus Johnson", "role": "trainer", "is_super_admin": true}', now(), now()
),
(
  '00000000-0000-0000-0000-000000000000',
  ...
  '{"provider": "email", "providers": ["email"]}',
  '{"full_name": "Sofia Martinez", "role": "trainer", "is_super_admin": true}', now(), now()
) ON CONFLICT (id) DO NOTHING;
...
-- Update Trainer Details with Rich Data (Triggers handles Profile/Trainer base rows)
